$(function(){
  ...
  var clientwidth2 = (clients * 200); // 140px width for each client item
  $clientcarousel2.css('width',clientwidth);

  
  var rotating2 = true;
  var clientspeed2 = 3000;
  var seeclients2 = setInterval(rotateClients2, clientspeed2);
